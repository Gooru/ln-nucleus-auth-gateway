...
public class RouteConstants {
    ...
    public static final String EP_NUCLUES_AUTH_GLA_VERSION_ANONYMOUS_LOGIN = API_GLA_VERSION_BASE_ROUTE + LOGIN + SEP
        + ANONYMOUS;
    ...
    public static final String EP_NUCLUES_AUTH_EMAIL_CONFIRM = API_BASE_ROUTE + USERS + SEP + USER_ID + SEP
        + EMAIL_CONFIRM;

    // User preference
    public static final String EP_NUCLUES_AUTH_USER_ID_PREFS = API_BASE_ROUTE + USERS + SEP + USER_ID + SEP
        + USER_PREFERENCES;
